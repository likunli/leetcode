...
class Solution {
    ...
    // (value and position) of your guess to the secret word.  Also, 
    ...
    // At the end of any number of calls, if you have made 10 or less calls to master.
    // guess and at least one of these guesses was the secret, you pass the testcase.
